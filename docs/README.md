...
The docs folder contains architecture, product, planning, hardware, and milestone documentation for GAS Smart Tracker by Groupe Auto Solus.
...
- `JOURNAL.md`: Chronological project decisions and milestone notes.
